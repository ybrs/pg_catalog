# Task 61:
# Task 61: Implemented `current_schemas(boolean)` UDF. Returns `['pg_catalog', 'public']` for true, empty list for false/NULL.
# Full testing blocked by Rust environment (1.75.0) incompatibility with project dependencies.
